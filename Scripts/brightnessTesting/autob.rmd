...
userOpinion292_3922 <- vector()

for (i in 292:392){
userOpinion292_3922[i] <- readline(prompt = "Is this image bright(1), good(0)")
...
```
```{r}
opinion1_392<-readRDS("~/Magneto2020/BrightnessTesting/2006261-392opinionsB")
```
...
plot(lmod, which = 1:6)
```
# Finding the McFadden Pseudo- $R^2$ Value 0.2573778
...
name <- "AGC--H-19260117-19260119.tif"
...
```{r}
saveRDS(opinion1_392, file = "~/Magneto2020/2006261-392opinionsB")
readRDS("~/Magneto2020/2006261-392opinionsB")
```



```{r}
#'Using a logistic regression to find coefficients, uses the result to compute a probability of the image being #'bright (392 observations) with McFadden Pseudo- $R^2$ Value 0.2573778
#'
