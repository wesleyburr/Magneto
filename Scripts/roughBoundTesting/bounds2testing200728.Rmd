...
if (bright == FALSE) {
  imageProcessed <- .not_bright_image(image, cutoffQuantile = 0.95)
}
imageMatrix <- imageProcessed$gaussImageMatrix[-c(0:200),-c(0:imageSides$Start, imageSides$End:ncol(imageProcessed$imageMatrix))]
```
