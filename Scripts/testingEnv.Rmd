...
library("zoo")
  ...
  topEnvelope <- .top_env(rolledImage, sepDist = 20, max_roc = 50)
  topEnvelopeScaled <- nrow(imageMatrix) - bottomcut + topEnvelope 
  bottomEnvelope <- .bottom_env(rolledImage, sepDist = 20, max_roc = 50)
  bottomEnvelopeScaled <- nrow(imageMatrix) - bottomcut + bottomEnvelope
  plot(imageMatrix)#processed image
  lines(topEnvelopeScaled, col = "green")
  lines(bottomEnvelopeScaled, col = "green")
