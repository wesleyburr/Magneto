...
```{r}
TestData2 <- DiffWithAndWithoutGauss
TestData <- read.csv("DiffWAWOG4948IQR.csv")
```
...
ggplot(Means, aes(x = Range, fill = mean)) + geom_density(alpha = 0.2) + geom_vline(xintercept = 0.09, linetype = "dashed") + geom_vline(xintercept = 0.0227, linetype = "dashed")
```
```{r meansNoZero}
Gauss <- data.frame(Range = TestData2$GaussMatNonZeroMean)
Mat <- data.frame(Range = TestData2$noZeroMean)
...
```{r IQR}
Gauss <- data.frame(IQRRange = (TestData$GaussMatQ3 - TestData$GaussMatQ1))
Mat <- data.frame(IQRRange = (TestData$MatQ3 - TestData$MatQ1))

Gauss$IQR <- "forGauss"
Mat$IQR <- "Image"

IQRs <- rbind(Gauss, Mat)

ggplot(IQRs,aes(x = IQRRange, fill = IQR)) + geom_density(,alpha = 0.2, position = "identity")+ geom_vline(xintercept = 0.09, linetype = "dashed") + geom_vline(xintercept = 0.0227, linetype = "dashed") 
```
...
```{r}
for (i in 1:4948){
  if(TestData$MatMean[i] < 0.02){
    
        print(c(TestData$MatMean[i],i))
...
plot(WithGauss)
```
```{r mm0.09338-gm0.0136}
noGauss <-  image_import("AGC-D-19071008-19071010.tif","/home/ben/magneto/Images/AGC-D-19040830-19071124/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm0.0826-gm0.01206}
noGauss <-  image_import("AGC-V-19230711-19230713.tif","/home/ben/magneto/Images/AGC-V-19230102-19260101/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm.0738-gm0.01077}
noGauss <-  image_import("AGC-Z-19260121-19260123.tif","/home/ben/magneto/Images/AGC-V-19260101-19281230/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
library("rtiff")
writeTIFF(WithGauss, "closerLook.tiff")
plot(noGauss)
plot(WithGauss)
```

```{r mm.0604-gm0.00882}
noGauss <-  image_import("AGC-D-19250223-19250225.tif","/home/ben/magneto/Images/Range/AGC-D-19240306-19270426/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm.054-gm0.00788}
noGauss <-  image_import("AGC-Z-19311124-19311126-Readme.tif","/home/ben/magneto/Images/Range/AGC-V-19281231-19320101/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm.0385-gm0.00563}
noGauss <-  image_import("AGC-D-19310628-19310630.tif","/home/ben/magneto/Images/AGC-D-19300619-19330612/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm.027-gm0.0039}
noGauss <-  image_import("AGC-V-19230830-19230831.tif","/home/ben/magneto/Images/Range/AGC-V-19230102-19260101/")

mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
WithGauss2 <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.01, nw = 3 ) )
mean(WithGauss)
plot(noGauss)
plot(WithGauss)
plot(WithGauss2)
...
```{r mm.0227-gm0.0033}
noGauss <-  image_import("AGC-D-19340912-19340914-Readme.tif","/home/ben/magneto/Images/AGC-D-19330601-19360630/")
...
```{r mm.0230-gm0.00337}
noGauss <-  image_import("AGC-Z-19280727-19280729-Readme.tif","/home/ben/magneto/Images/AGC-V-19260101-19281230/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
```{r mm.01806-gm0.00263}
noGauss <-  image_import("AGC-Z-19270414-19270415-Readme.tif","/home/ben/magneto/Images/Range/AGC-V-19260101-19281230/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
mean(WithGauss)
...
plot(WithGauss)
```
```{r mm0.4860082FirstInBetightTest}
noGauss <-  image_import("AGC-HDZ-19430207-19430208.tif","/home/ben/magneto/Images/AGC-D-19420521-19430714/")
mean(noGauss)
source("~/Magneto2020/Scripts/BreakoutOptimization.R")
WithGauss <- t( apply( noGauss, MARGIN = 1, FUN = deconvGauss, sig = 10, kern.trunc = 0.05, nw = 3 ) )
...
#Start with looking at individual histograms
```{r}
meanProblem <- c(0,0,0.1,0.2,0,0.3,0,0)
tempVec <- vector()
for (i in 1:length(meanProblem)){
if (meanProblem[i] != 0){
  tempVec <- c(tempVec, meanProblem[i])
}
}  
mean(meanProblem[meanProblem != 0])
mean(tempVec)
meanp <- c(0.1,0.2,0.3)
mean(meanp)
```
...
i = 1
fileWithPath <- "~/Magneto2020/ImagesPNG/AGC-HDZ-19430207-19430208.tif.png"
...
```{r comp}
fileWithPath1 <- "~/Magneto2020/ImagesPNG/AGC-HDZ-19430207-19430208.tif.png"
...
fileWithPath1 <- "~/Magneto2020/ImagesPNG/AGC-Z-19290121-19290123.tif.png"
fileWithPath2 <- "~/Magneto2020/ImagesPNG/AGC--H-19260101-19260103.tif.png"
temp1 <- readPNG(fileWithPath1)
temp2 <- readPNG(fileWithPath2)
Mat1 <- data.frame(Range = temp1)
